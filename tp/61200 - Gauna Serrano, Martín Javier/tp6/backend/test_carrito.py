...
Ejecutar con: python test_carrito.py
"""
...
def main():
    ...
    with httpx.Client() as client:
        ...
        if response.status_code == 200:
            ...
            print_success("Usuario autenticado - Token obtenido")
        else:
        ...
        # ========================================
        # TEST 5: Agregar producto existente
        # ========================================
        ...
        # ========================================
        # TEST 6: Intentar agregar sin stock
        # ========================================
        print_test("TEST 6: Intentar agregar producto sin stock (1000 unidades)")
        ...
        if response.status_code == 400:
            print_success("Error 400 por stock insuficiente")
        else:
            print_error("Debería retornar error 400")
        
        # ========================================
        # TEST 7: Producto inexistente
        # ========================================
        ...
        if response.status_code == 404:
            print_success("Error 404 por producto inexistente")
        else:
        ...
        # ========================================
        print_test("TEST 8: Quitar producto (ID 1)")
        ...
        if response.status_code == 200:
            print_success("Producto eliminado")
            
            response = client.get(f"{BASE_URL}/carrito", headers=auth_headers)
            data = response.json()
            if len(data["items"]) == 1:
                print_success("Carrito actualizado correctamente")
            else:
        ...
        # ========================================
        # TEST 9: Eliminar producto inexistente
        # ========================================
        print_test("TEST 9: Quitar producto inexistente en carrito")
        ...
        if response.status_code == 404:
            print_success("Error 404 correcto al eliminar inexistente")
        else:
            print_error("Debería retornar 404")
        ...
        if response.status_code == 401:
            print_success("Error 401 correctamente retornado")
        else:
            print_error("Debería retornar 401")
    ...
    print("   - POST /carrito/cancelar")
    print("   - Validaciones de stock, errores y autenticación")
    print("="*60)
...
if __name__ == "__main__":
    print("\n⚠  IMPORTANTE: Asegúrate de que el servidor esté corriendo en http://127.0.0.1:8000")
    print("   Ejecuta en otra terminal: uvicorn main:app --reload")
