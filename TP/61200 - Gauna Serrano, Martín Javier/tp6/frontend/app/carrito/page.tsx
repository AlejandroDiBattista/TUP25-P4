...
export default function FinalizarCompraPage() {
  ...
  const validarFormulario = (): string | null => {
    ...
    if (!/^\d{16}$/.test(tarjetaDigits)) {
      errores.tarjeta = 'La tarjeta debe tener 16 dígitos';
    }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <section className="card-surface p-6 space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-500">{resumenActual.items.length} artículo(s)</p>
              </div>
              ...
              {resultado ? (
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col gap-3 pt-4 border-t border-gray-200">
                    <button onClick={() => router.push('/compras')} className="btn-primary w-full">
                ...
                <form className="space-y-6" onSubmit={realizarCompra}>
                  ...
                  <div className="bg-blue-50 border border-blue-100 text-blue-800 px-4 py-3 rounded-lg text-sm">
                    <p>
                      Verifica tus datos antes de continuar. Total a pagar:{' '}
                      <span className="font-semibold">${resumenActual.total.toFixed(2)}</span>.
                    </p>
                  </div>
